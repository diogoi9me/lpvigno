<style>
 ...
 #_form_15_ input[type="text"],#_form_15_ input[type="date"],#_form_15_ textarea { padding:6px; height:auto; border:#979797 1px solid; border-radius:4px; color:#000 !important; font-size:13px; -webkit-box-sizing:border-box; -moz-box-sizing:border-box; box-sizing:border-box; }
 #_form_15_ textarea { resize:none; }
 #_form_15_ ._submit { -webkit-appearance:none; cursor:pointer; font-family:arial, sans-serif; font-size:14px; text-align:center; background:#333 !important; border:0 !important; -moz-border-radius:4px !important; -webkit-border-radius:4px !important; border-radius:4px !important; color:#fff !important; padding:10px !important; }
 ...
 #_form_15_ ._error { display:block; position:absolute; font-size:13px; z-index:10000001; }
 #_form_15_ ._error._above { padding-bottom:4px; top:-41px; right:0; }
 ...
 #_form_15_ ._error-inner { padding:8px 12px; background-color:#f37c7b; font-size:13px; font-family:arial, sans-serif; color:#fff; text-align:center; text-decoration:none; -webkit-border-radius:4px; -moz-border-radius:4px; border-radius:4px; }
...
<form method="POST" action="http://crm.i9me.com.br/proc.php" id="_form_15_" class="_form _form_15 _inline-form  _dark" novalidate>
  ...
  <div class="_form-content">
    <div class="_form_element _x22042813 _full_width _clear" >
      <div class="_form-title">
        Cadastre-se para receber atualizações por e-mail
      </div>
    </div>
    <div class="_form_element _x06860889 _full_width _clear" >
    ...
    <div class="_form_element _x54970922 _full_width " >
    ...
    <div class="_form_element _x08411266 _full_width " >
      <label class="_form-label">
        Sobrenome
      </label>
      <div class="_field-wrapper">
    ...
    <div class="_form_element _x64200541 _full_width " >
      <label class="_form-label">
        E-mail*
      </label>
      <div class="_field-wrapper">
    ...
    <div class="_form_element _x52531755 _full_width " >
      <label class="_form-label">
        Telefone*
      </label>
      <div class="_field-wrapper">
        <input type="text" name="phone" placeholder="Celular / Whatsapp" required/>
      </div>
    </div>
    <div class="_form_element _field14 _full_width " >
      ...
      <div class="_field-wrapper">
        <input type="text" name="field[14]" value="" placeholder="" required/>
      </div>
    </div>
    <div class="_form_element _field11 _full_width " >
      ...
      <div class="_row _checkbox-radio">
        ...
        <span>
          <label for="field_11Moda Feminina">
            Moda Feminina
          </label>
        </span>
      </div>
      <div class="_row _checkbox-radio">
        ...
        <span>
          <label for="field_11Moda Masculina">
            Moda Masculina
          </label>
        </span>
      </div>
      <div class="_row _checkbox-radio">
        ...
        <span>
          <label for="field_11Moda Infantil">
            Moda Infantil
          </label>
        </span>
      </div>
      ...
      <div class="_row _checkbox-radio">
        ...
        <span>
          <label for="field_11Moda Plus Size">
            Moda Plus Size
          </label>
        </span>
      </div>
      <div class="_row _checkbox-radio">
        <input id="field_11Bolsas e Calçados" type="checkbox" name="field[11][]" value="Bolsas e Calçados"   >
        <span>
          <label for="field_11Bolsas e Calçados">
            Bolsas e Calçados
          </label>
        </span>
      </div>
      <div class="_row _checkbox-radio">
        ...
        <span>
          <label for="field_11Jóias e Acessórios">
            Jóias e Acessórios
          </label>
        </span>
      </div>
      ...
      <div class="_row _checkbox-radio">
        ...
        <span>
          <label for="field_11Outras Opções">
            Outras Opções
          </label>
        </span>
      </div>
...
window.cfields = {"14":"empresa","11":"segmentos_de_moda","12":"observaes","13":"termos_e_condies","10":"origem"};
